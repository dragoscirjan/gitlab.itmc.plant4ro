...
<body <?php body_class() ?>>
	...
	<header id="zl_siteheader">
		...
		<div class="zl_mainmenu">
			...
			<!-- Menu trigger -->
			<div class="small-2 column text-center zl_bgrmnwrp">
				<div class="zl_bgr_menu_trigger">
					<span class="zl_burgermenu"></span>
				</div>
			</div>
			
			<!-- Sidebar Trigger -->
			<div class="small-5 column zl_srccontainer text-right">
				<!-- Search Form -->
		...
		<!-- Branding -->
		<div class="zl_branding text-center">
			<?php 
			$logo = zl_option('logo');
